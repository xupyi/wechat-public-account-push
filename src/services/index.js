...
// 				let ymd = "2022-11-08" // 自定义日期-测试
				...
				let dateArr = [{
						...
						time: "2023-08-22",
						name: "七夕节",
						bless: "今天是情人节，愿我的祝福像高高低低的风铃,给你带去叮叮铛铛的快乐！"
					},{
						time: "2023-09-29",
						name: "中秋节",
						bless: "今天是中秋节，愿我的祝福像高高低低的风铃,给你带去叮叮铛铛的快乐！"
					},{
						time: "2023-10-01",
						name: "国庆节",
						bless: "今天是国庆节，愿我的祝福像高高低低的风铃,给你带去叮叮铛铛的快乐！"
					},
					// ......
				]
        ...
        if(arr_index==-1){
          return week+"获取最近节日失败，请前往补充"
				...
				if (res.time == ymd) {
					...
					text = "最近一个节日是" + res.name + "，还有" + res1 + "天，" + (res1 < 3 ? '节日快到了，开心心！' : '认真工作，认真生活！')
